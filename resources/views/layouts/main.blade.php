                    ...
                    <div class="classy-menu">
                        ...
                        <div class="classynav">
                            <ul>
                                ...
                                <li><a href="#">Pages</a>
                                    <ul class="dropdown">
                                        ...
                                        <li><a href="{{asset('/assets/catagory.html')}}">Catagory</a></li>
                                        <li><a href="{{asset('/assets/single-post.html')}}">Single Post</a></li>
                                        <li><a href="{{asset('/assets/contact.html')}}">Contact</a></li>
                                        <li><a href="{{asset('/assets/elements.html')}}">Elements</a></li>
                                    </ul>
                                </li>
                                <li><a href="#">Sport</a>
                                    <ul class="dropdown">
                            ...
                            <div class="header-add-area">
                                <a href="#">
                                    <img src="{{asset('/assets/img/bg-img/add.png')}}" alt="">
                                </a>
                            </div>
                        </div>
                        <!-- Nav End -->
